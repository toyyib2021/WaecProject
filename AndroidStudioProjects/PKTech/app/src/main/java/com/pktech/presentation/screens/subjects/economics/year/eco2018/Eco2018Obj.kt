...
onYesClickTest: () -> Unit,
    ...
    val economicsVM: Economics2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2018
    val questionRoute = EconomicsObjYear.Obj2018.route
    ...
    val economicsQuestion by economicsVM.getEconomics2018.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2018.value
