package com.pktech.presentation.screens.subjects.biology.year.bio2014
...
fun Bio2014Obj(
    ...
    val biologyVM: Biology2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2014
    val questionRoute = BiologyObjYear.Obj2014.route
    ...
    val biologyQuestion by biologyVM.getBiology2014.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2014.value
