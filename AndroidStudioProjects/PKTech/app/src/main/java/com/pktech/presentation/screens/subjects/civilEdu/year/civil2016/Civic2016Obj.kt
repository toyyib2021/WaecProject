...
fun Civic2016Obj(
    ...
    val civicEduVM: CivicEdu2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CIVICEDU2016
    val questionRoute = CivicEduObjYear.Obj2016.route
    ...
    val civicEduQuestion by civicEduVM.getCivicEdu2016.observeAsState(listOf<Agriculture>())
    val civicEduQuestionR = civicEduVM.getCivicEdu2016.value
