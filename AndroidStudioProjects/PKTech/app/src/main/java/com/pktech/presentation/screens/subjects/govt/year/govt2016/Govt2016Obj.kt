...
fun Govt2016Obj(
    ...
    val governmentVM: Government2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2016
    val questionRoute = GovernmentObjYear.Obj2016.route
    ...
    val governmentQuestion by governmentVM.getGovernment2016.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2016.value
