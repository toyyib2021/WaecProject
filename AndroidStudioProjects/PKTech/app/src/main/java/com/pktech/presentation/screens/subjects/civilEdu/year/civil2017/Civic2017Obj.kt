...
fun Civic2017Obj(
    ...
    val civicEduVM: CivicEdu2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CIVICEDU2017
    val questionRoute = CivicEduObjYear.Obj2017.route
    ...
    val civicEduQuestion by civicEduVM.getCivicEdu2017.observeAsState(listOf<Agriculture>())
    val civicEduQuestionR = civicEduVM.getCivicEdu2017.value
