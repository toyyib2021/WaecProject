...
fun Agric2016Obj(
    ...
    val agricultureVM: Agric2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2016
    val questionRoute = AgricultureObjYear.Obj2016.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2016.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2016.value
