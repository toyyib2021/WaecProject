...
fun Chy2019Obj(
    ...
    val chemistryVM: Chemistry2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2019
    val questionRoute = ChemistryObjYear.Obj2019.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2019.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2019.value
