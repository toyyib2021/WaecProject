...
fun Govt2015Obj(
    ...
    val governmentVM: Government2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2015
    val questionRoute = GovernmentObjYear.Obj2015.route
    ...
    val governmentQuestion by governmentVM.getGovernment2015.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2015.value
