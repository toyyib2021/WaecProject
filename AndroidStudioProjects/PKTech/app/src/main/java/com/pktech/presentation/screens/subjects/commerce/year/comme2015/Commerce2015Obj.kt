...
fun Commerce2015Obj(
    ...
    val commerceVM: Commerce2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2015
    val questionRoute = CommerceObjYear.Obj2015.route
    ...
    val commerceQuestion by commerceVM.getCommerce2015.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2015.value
