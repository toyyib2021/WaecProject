...
fun Commerce2017Obj(
    ...
    val commerceVM: Commerce2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2017
    val questionRoute = CommerceObjYear.Obj2017.route
    ...
    val commerceQuestion by commerceVM.getCommerce2017.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2017.value
