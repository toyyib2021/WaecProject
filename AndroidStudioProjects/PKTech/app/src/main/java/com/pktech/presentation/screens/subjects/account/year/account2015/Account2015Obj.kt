...
fun Account2015Obj(
    ...
    val account2015VM: Account2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2015
    val questionRoute = AccountObjYear.Obj2015.route
    ...
    val account2015 by account2015VM.getAccount2015.observeAsState(listOf<Account>())
    val account2015R = account2015VM.getAccount2015.value
    account2015::class.java
    ...
    val questionSize = account2015R?.account?.size
    ...
    val questionIndex = account2015R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2015R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2015R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2015R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2015R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2015R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2015R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2015R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2015R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2015R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2015R?.account?.get(currentIndex)?.objective?.questionEnd
