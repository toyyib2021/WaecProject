...
fun Phy2015Obj(
    ...
    val physicsVM: Physics2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2015
    val questionRoute = PhysicsObjYear.Obj2015.route
    ...
    val physicsQuestion by physicsVM.getPhysics2015.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2015.value
