...
fun Account2014Obj(
    ...
    val account2014VM: Account2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2014
    val questionRoute = AccountObjYear.Obj2014.route
    ...
    val account2014 by account2014VM.getAccount2014.observeAsState(listOf<Account>())
    val account2014R = account2014VM.getAccount2014.value
    account2014::class.java
    ...
    val questionSize = account2014R?.account?.size
    ...
    val questionIndex = account2014R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2014R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2014R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2014R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2014R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2014R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2014R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2014R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2014R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2014R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2014R?.account?.get(currentIndex)?.objective?.questionEnd
