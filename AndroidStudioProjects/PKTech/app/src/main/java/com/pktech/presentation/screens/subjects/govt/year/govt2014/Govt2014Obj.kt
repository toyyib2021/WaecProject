...
fun Govt2014Obj(
    ...
    val governmentVM: Government2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2014
    val questionRoute = GovernmentObjYear.Obj2014.route
    ...
    val governmentQuestion by governmentVM.getGovernment2014.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2014.value
