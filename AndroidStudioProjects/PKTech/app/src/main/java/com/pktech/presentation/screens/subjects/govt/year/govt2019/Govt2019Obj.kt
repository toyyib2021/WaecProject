...
fun Govt2019Obj(
    ...
    val governmentVM: Government2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2019
    val questionRoute = GovernmentObjYear.Obj2019.route
    ...
    val governmentQuestion by governmentVM.getGovernment2019.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2019.value
