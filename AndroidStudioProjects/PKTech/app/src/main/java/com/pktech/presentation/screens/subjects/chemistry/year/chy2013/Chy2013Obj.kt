...
fun Chy2013Obj(
    ...
    val chemistryVM: Chemistry2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2013
    val questionRoute = ChemistryObjYear.Obj2013.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2013.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2013.value
