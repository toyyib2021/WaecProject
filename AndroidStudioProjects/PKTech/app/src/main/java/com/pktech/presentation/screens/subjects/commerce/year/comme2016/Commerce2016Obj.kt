...
fun Commerce2016Obj(
    ...
    val commerceVM: Commerce2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2016
    val questionRoute = CommerceObjYear.Obj2016.route
    ...
    val commerceQuestion by commerceVM.getCommerce2016.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2016.value
