...
fun Account2016Obj(
    ...
    val account2016VM: Account2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2016
    val questionRoute = AccountObjYear.Obj2016.route
    ...
    val account2016 by account2016VM.getAccount2016.observeAsState(listOf<Account>())
    val account2016R = account2016VM.getAccount2016.value
    account2016::class.java
    ...
    val questionSize = account2016R?.account?.size
    ...
    val questionIndex = account2016R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2016R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2016R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2016R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2016R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2016R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2016R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2016R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2016R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2016R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2016R?.account?.get(currentIndex)?.objective?.questionEnd
