...
fun Phy2019Obj(
    ...
    val physicsVM: Physics2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2019
    val questionRoute = PhysicsObjYear.Obj2019.route
    ...
    val physicsQuestion by physicsVM.getPhysics2019.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2019.value
