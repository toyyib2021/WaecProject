...
fun Eco2020Obj(
    ...
    val economicsVM: Economics2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2020
    val questionRoute = EconomicsObjYear.Obj2020.route
    ...
    val economicsQuestion by economicsVM.getEconomics2020.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2020.value
