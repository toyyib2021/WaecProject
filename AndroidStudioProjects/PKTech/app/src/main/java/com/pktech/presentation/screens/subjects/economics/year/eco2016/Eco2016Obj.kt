...
fun Eco2016Obj(
    ...
    val economicsVM: Economics2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2016
    val questionRoute = EconomicsObjYear.Obj2016.route
    ...
    val economicsQuestion by economicsVM.getEconomics2016.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2016.value
