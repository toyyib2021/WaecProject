...
fun Eco2015Obj(
    ...
    val economicsVM: Economics2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2015
    val questionRoute = EconomicsObjYear.Obj2015.route
    ...
    val economicsQuestion by economicsVM.getEconomics2015.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2015.value
