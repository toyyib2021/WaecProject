...
fun Govt2018Obj(
    ...
    val governmentVM: Government2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2018
    val questionRoute = GovernmentObjYear.Obj2018.route
    ...
    val governmentQuestion by governmentVM.getGovernment2018.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2018.value
