...
fun Bio2019Obj(
    ...
    val biologyVM: Biology2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2019
    val questionRoute = BiologyObjYear.Obj2019.route
    ...
    val biologyQuestion by biologyVM.getBiology2019.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2019.value
