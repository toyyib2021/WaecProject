...
fun Bio2020Obj(
    ...
    val biologyVM: Biology2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2020
    val questionRoute = BiologyObjYear.Obj2020.route
    ...
    val biologyQuestion by biologyVM.getBiology2020.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2020.value
