...
fun Chy2018Obj(
    ...
    val chemistryVM: Chemistry2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2018
    val questionRoute = ChemistryObjYear.Obj2018.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2018.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2018.value
