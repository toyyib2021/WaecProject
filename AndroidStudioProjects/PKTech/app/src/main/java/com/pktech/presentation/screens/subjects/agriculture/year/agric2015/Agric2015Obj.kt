package com.pktech.presentation.screens.subjects.agriculture.year.agric2015
...
fun Agric2015Obj(
    ...
    val agricultureVM: Agric2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2015
    val questionRoute = AgricultureObjYear.Obj2015.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2015.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2015.value
