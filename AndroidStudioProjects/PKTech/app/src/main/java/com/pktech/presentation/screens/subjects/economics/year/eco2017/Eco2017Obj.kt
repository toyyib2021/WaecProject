...
fun Eco2017Obj(
    ...
    val economicsVM: Economics2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2017
    val questionRoute = EconomicsObjYear.Obj2017.route
    ...
    val economicsQuestion by economicsVM.getEconomics2017.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2017.value
