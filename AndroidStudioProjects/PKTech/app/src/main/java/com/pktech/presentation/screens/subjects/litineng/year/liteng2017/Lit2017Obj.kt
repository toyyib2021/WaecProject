...
fun Lit2017Obj(
    ...
    val literatureVM: Literature2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2017
    val questionRoute = LiteratureObjYear.Obj2017.route
    ...
    val literatureQuestion by literatureVM.getLiterature2017.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2017.value
