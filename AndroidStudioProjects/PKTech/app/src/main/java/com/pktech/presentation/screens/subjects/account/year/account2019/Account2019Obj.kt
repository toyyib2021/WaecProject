...
fun Account2019Obj(
    ...
    val account2019VM: Account2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2019
    val questionRoute = AccountObjYear.Obj2019.route
    ...
    val account2019 by account2019VM.getAccount2019.observeAsState(listOf<Account>())
    val account2019R = account2019VM.getAccount2019.value
    account2019::class.java
    ...
    val questionSize = account2019R?.account?.size
    ...
    val questionIndex = account2019R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2019R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2019R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2019R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2019R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2019R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2019R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2019R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2019R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2019R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2019R?.account?.get(currentIndex)?.objective?.questionEnd
