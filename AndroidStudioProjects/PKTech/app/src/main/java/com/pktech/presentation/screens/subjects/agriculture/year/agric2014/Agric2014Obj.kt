...
fun Agric2014Obj(
    ...
    val agriculture2014VM: Agric2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2014
    val questionRoute = AgricultureObjYear.Obj2014.route
    ...
    val agriculture2014 by agriculture2014VM.getAgric2014.observeAsState(listOf<Agriculture>())
    val agriculture2014R = agriculture2014VM.getAgric2014.value
    agriculture2014::class.java
    ...
    val questionSize = agriculture2014R?.agriculture?.size
    ...
    val questionIndex = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.id
    val currentQuestion = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.question
    val mainOptionA = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.optionA
    val mainOptionB = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.optionB
    val mainOptionC = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.optionC
    val mainOptionD = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.optionD
    val answer = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.explanation
    val currentInstructions = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.instructions
    val correctOption = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.correctOption
    val underline = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = agriculture2014R?.agriculture?.get(currentIndex)?.objective?.questionEnd
