...
fun Phy2014Obj(
    ...
    val physicsVM: Physics2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2014
    val questionRoute = PhysicsObjYear.Obj2014.route
    ...
    val physicsQuestion by physicsVM.getPhysics2014.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2014.value
