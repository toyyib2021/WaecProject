...
fun Commerce2019Obj(
    ...
    val commerceVM: Commerce2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2019
    val questionRoute = CommerceObjYear.Obj2019.route
    ...
    val commerceQuestion by commerceVM.getCommerce2019.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2019.value
