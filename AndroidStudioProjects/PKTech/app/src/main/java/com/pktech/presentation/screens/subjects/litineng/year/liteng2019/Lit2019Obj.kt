...
fun Lit2019Obj(
    ...
    val literatureVM: Literature2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2019
    val questionRoute = LiteratureObjYear.Obj2019.route
    ...
    val literatureQuestion by literatureVM.getLiterature2019.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2019.value
