...
fun Civic2020Obj(
    ...
    val civicEduVM: CivicEdu2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CIVICEDU2020
    val questionRoute = CivicEduObjYear.Obj2020.route
    ...
    val civicEduQuestion by civicEduVM.getCivicEdu2020.observeAsState(listOf<Agriculture>())
    val civicEduQuestionR = civicEduVM.getCivicEdu2020.value
