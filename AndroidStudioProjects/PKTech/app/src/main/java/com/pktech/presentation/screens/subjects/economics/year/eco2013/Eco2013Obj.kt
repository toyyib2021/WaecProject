package com.pktech.presentation.screens.subjects.economics.year.eco2013
...
import com.pktech.presentation.screens.subjects.economics.year.eco2012.Economics2012VM
...
fun Eco2013Obj(
    ...
    val economicsVM: Economics2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2013
    val questionRoute = EconomicsObjYear.Obj2013.route
    ...
    val economicsQuestion by economicsVM.getEconomics2013.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2013.value
