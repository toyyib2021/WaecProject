...
fun Phy2020Obj(
    ...
    val physicsVM: Physics2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2020
    val questionRoute = PhysicsObjYear.Obj2020.route
    ...
    val physicsQuestion by physicsVM.getPhysics2020.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2020.value
