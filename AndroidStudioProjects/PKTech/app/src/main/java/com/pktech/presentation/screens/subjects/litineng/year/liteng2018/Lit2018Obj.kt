...
fun Lit2018Obj(
    ...
    val literatureVM: Literature2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2018
    val questionRoute = LiteratureObjYear.Obj2018.route
    ...
    val literatureQuestion by literatureVM.getLiterature2018.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2018.value
