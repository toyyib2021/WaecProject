...
fun Chy2016Obj(
    ...
    val chemistryVM: Chemistry2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2016
    val questionRoute = ChemistryObjYear.Obj2016.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2016.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2016.value
