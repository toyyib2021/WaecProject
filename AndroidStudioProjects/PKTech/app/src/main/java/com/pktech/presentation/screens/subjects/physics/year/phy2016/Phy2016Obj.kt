package com.pktech.presentation.screens.subjects.physics.year.phy2016
...
fun Phy2016Obj(
    ...
    val physicsVM: Physics2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2016
    val questionRoute = PhysicsObjYear.Obj2016.route
    ...
    val physicsQuestion by physicsVM.getPhysics2016.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2016.value
