...
fun Lit2016Obj(
    ...
    val literatureVM: Literature2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2016
    val questionRoute = LiteratureObjYear.Obj2016.route
    ...
    val literatureQuestion by literatureVM.getLiterature2016.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2016.value
