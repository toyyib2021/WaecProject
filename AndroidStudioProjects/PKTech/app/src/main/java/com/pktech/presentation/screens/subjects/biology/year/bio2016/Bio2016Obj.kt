...
fun Bio2016Obj(
    ...
    val biologyVM: Biology2016VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2016
    val questionRoute = BiologyObjYear.Obj2016.route
    ...
    val biologyQuestion by biologyVM.getBiology2016.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2016.value
