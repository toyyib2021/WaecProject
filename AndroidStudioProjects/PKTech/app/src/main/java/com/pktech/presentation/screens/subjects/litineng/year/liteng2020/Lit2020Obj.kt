...
fun Lit2020Obj(
    ...
    val literatureVM: Literature2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2020
    val questionRoute = LiteratureObjYear.Obj2020.route
    ...
    val literatureQuestion by literatureVM.getLiterature2020.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2020.value
