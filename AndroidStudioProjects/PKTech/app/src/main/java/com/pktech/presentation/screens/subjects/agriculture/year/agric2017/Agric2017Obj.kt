...
fun Agric2017Obj(
    ...
    val agricultureVM: Agric2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2017
    val questionRoute = AgricultureObjYear.Obj2017.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2017.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2017.value
