...
fun Commerce2020Obj(
    ...
    val commerceVM: Commerce2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2020
    val questionRoute = CommerceObjYear.Obj2020.route
    ...
    val commerceQuestion by commerceVM.getCommerce2020.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2020.value
