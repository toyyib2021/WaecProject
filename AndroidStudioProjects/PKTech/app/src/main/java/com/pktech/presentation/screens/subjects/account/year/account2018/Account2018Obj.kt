...
fun Account2018Obj(
    ...
    val account2018VM: Account2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2018
    val questionRoute = AccountObjYear.Obj2018.route
    ...
    val account2018 by account2018VM.getAccount2018.observeAsState(listOf<Account>())
    val account2018R = account2018VM.getAccount2018.value
    account2018::class.java
    ...
    val questionSize = account2018R?.account?.size
    ...
    val questionIndex = account2018R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2018R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2018R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2018R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2018R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2018R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2018R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2018R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2018R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2018R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2018R?.account?.get(currentIndex)?.objective?.questionEnd
