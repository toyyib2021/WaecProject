...
fun Account2013Obj(
    ...
    val account2013VM: Account2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2013
    ...
    val account2013 by account2013VM.getAccount2013.observeAsState(listOf<Account>())
    val account2013R = account2013VM.getAccount2013.value
    account2013::class.java
    ...
    val questionSize = account2013R?.account?.size
    ...
    val questionIndex = account2013R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2013R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2013R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2013R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2013R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2013R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2013R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2013R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2013R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2013R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2013R?.account?.get(currentIndex)?.objective?.questionEnd
