package com.pktech.presentation.screens.subjects.litineng.year.liteng2015
...
import com.pktech.presentation.screens.subjects.litineng.year.liteng2012.Literature2012VM
...
fun Lit2015Obj(
    ...
    val literatureVM: Literature2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2015
    val questionRoute = LiteratureObjYear.Obj2015.route
    ...
    val literatureQuestion by literatureVM.getLiterature2015.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2015.value
    literatureQuestion::class.java
    ...
    val questionSize = literatureQuestionR?.literature?.size
    ...
    val questionIndex = literatureQuestionR?.literature?.get(currentIndex)?.objective?.id
    val currentQuestion = literatureQuestionR?.literature?.get(currentIndex)?.objective?.question
    val mainOptionA = literatureQuestionR?.literature?.get(currentIndex)?.objective?.optionA
    val mainOptionB = literatureQuestionR?.literature?.get(currentIndex)?.objective?.optionB
    val mainOptionC = literatureQuestionR?.literature?.get(currentIndex)?.objective?.optionC
    val mainOptionD = literatureQuestionR?.literature?.get(currentIndex)?.objective?.optionD
    val answer = literatureQuestionR?.literature?.get(currentIndex)?.objective?.explanation
    val currentInstructions = literatureQuestionR?.literature?.get(currentIndex)?.objective?.instructions
    val correctOption = literatureQuestionR?.literature?.get(currentIndex)?.objective?.correctOption
    val underline = literatureQuestionR?.literature?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = literatureQuestionR?.literature?.get(currentIndex)?.objective?.questionEnd
