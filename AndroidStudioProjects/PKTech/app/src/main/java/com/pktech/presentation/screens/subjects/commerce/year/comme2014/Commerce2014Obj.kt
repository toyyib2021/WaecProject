...
fun Commerce2014Obj(
    ...
    val commerceVM: Commerce2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2014
    val questionRoute = CommerceObjYear.Obj2014.route
    ...
    val commerceQuestion by commerceVM.getCommerce2014.observeAsState(listOf<Agriculture>())
    val commerceQuestionR = commerceVM.getCommerce2014.value
