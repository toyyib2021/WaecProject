...
fun Lit2013Obj(
    ...
    val literatureVM: Literature2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2013
    val questionRoute = LiteratureObjYear.Obj2013.route
    ...
    val literatureQuestion by literatureVM.getLiterature2013.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2013.value
