...
fun Govt2020Obj(
    ...
    val governmentVM: Government2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2020
    val questionRoute = GovernmentObjYear.Obj2020.route
    ...
    val governmentQuestion by governmentVM.getGovernment2020.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2020.value
