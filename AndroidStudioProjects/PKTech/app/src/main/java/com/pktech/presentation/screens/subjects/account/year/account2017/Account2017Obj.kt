...
fun Account2017Obj(
    ...
    val account2017VM: Account2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2017
    val questionRoute = AccountObjYear.Obj2017.route
    ...
    val account2017 by account2017VM.getAccount2017.observeAsState(listOf<Account>())
    val account2017R = account2017VM.getAccount2017.value
    account2017::class.java
    ...
    val questionSize = account2017R?.account?.size
    ...
    val questionIndex = account2017R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2017R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2017R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2017R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2017R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2017R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2017R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2017R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2017R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2017R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2017R?.account?.get(currentIndex)?.objective?.questionEnd
