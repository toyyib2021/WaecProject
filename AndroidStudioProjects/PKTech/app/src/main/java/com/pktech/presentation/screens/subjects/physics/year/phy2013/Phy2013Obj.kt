package com.pktech.presentation.screens.subjects.physics.year.phy2013
...
import com.pktech.presentation.screens.subjects.physics.year.phy2012.Physics2012VM
...
fun Phy2013Obj(
    ...
    val physicsVM: Physics2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2013
    val questionRoute = PhysicsObjYear.Obj2013.route
    ...
    val physicsQuestion by physicsVM.getPhysics2013.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2013.value
