...
fun questionIndexSheet1to80(optionSelectState: List<String>): List<QuestionIndexSheetDataClass> {

    val questionIndexSheet1to80 = listOf<QuestionIndexSheetDataClass>(
        QuestionIndexSheetDataClass(
            id = 1,
            bgColor = when (optionSelectState[0]) {
                "" -> White
        ...
        QuestionIndexSheetDataClass(
            id = 61,
            bgColor = when (optionSelectState[60]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[60]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 62,
            bgColor = when (optionSelectState[61]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[61]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 63,
            bgColor = when (optionSelectState[62]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[62]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 64,
            bgColor = when (optionSelectState[63]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[63]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 65,
            bgColor = when (optionSelectState[64]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[64]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 66,
            bgColor = when (optionSelectState[65]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[65]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
            ...
            id = 67,
            bgColor = when (optionSelectState[66]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[66]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
            ...
            id = 68,
            bgColor = when (optionSelectState[67]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[67]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
            ...
            id = 69,
            bgColor = when (optionSelectState[68]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[68]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
        ...
        QuestionIndexSheetDataClass(
            id = 70,
            bgColor = when (optionSelectState[69]) {
                "" -> White
                else -> {
                    VeryDarkGray
                }
            },
            txColor = when (optionSelectState[69]) {
                "" -> VeryDarkGray
                else -> {
                    White
                }
    ...
    return questionIndexSheet1to80
}

fun questionIndexSheet1to60(optionSelectState: List<String>): List<QuestionIndexSheetDataClass> {

    val questionIndexSheet1to60 = listOf<QuestionIndexSheetDataClass>(
        QuestionIndexSheetDataClass(
            id = 1,
            bgColor = when (optionSelectState[0]) {
                "" -> White
    ...
    return questionIndexSheet1to60
}
