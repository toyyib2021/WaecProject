...
fun Lit2014Obj(
    ...
    val literatureVM: Literature2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.LITERATURE2014
    val questionRoute = LiteratureObjYear.Obj2014.route
    ...
    val literatureQuestion by literatureVM.getLiterature2014.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2014.value
