package com.pktech.presentation.screens.subjects.chemistry.year.chy2014
...
fun Chy2014Obj(
    ...
    val chemistryVM: Chemistry2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2014
    val questionRoute = ChemistryObjYear.Obj2014.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2014.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2014.value
