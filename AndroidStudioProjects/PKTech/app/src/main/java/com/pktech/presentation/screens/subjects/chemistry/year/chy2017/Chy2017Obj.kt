package com.pktech.presentation.screens.subjects.chemistry.year.chy2017
...
import com.pktech.presentation.screens.subjects.chemistry.year.chy2012.Chemistry2012VM
...
fun Chy2017Obj(
    ...
    val chemistryVM: Chemistry2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2017
    val questionRoute = ChemistryObjYear.Obj2017.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2017.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2017.value
