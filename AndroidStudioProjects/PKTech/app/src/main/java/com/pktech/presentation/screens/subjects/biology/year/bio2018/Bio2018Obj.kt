...
fun Bio2018Obj(
    ...
    val biologyVM: Biology2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2018
    val questionRoute = BiologyObjYear.Obj2018.route
    ...
    val biologyQuestion by biologyVM.getBiology2018.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2018.value
