package com.pktech.presentation.screens.subjects.physics.year.phy2017
...
fun Phy2017Obj(
    ...
    val physicsVM: Physics2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2017
    val questionRoute = PhysicsObjYear.Obj2017.route
    ...
    val physicsQuestion by physicsVM.getPhysics2017.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2017.value
