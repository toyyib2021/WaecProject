...
fun Bio2017Obj(
    ...
    val biologyVM: Biology2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2017
    val questionRoute = BiologyObjYear.Obj2017.route
    ...
    val biologyQuestion by biologyVM.getBiology2017.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2017.value
