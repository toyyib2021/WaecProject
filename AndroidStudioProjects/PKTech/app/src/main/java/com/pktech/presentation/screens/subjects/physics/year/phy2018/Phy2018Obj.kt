...
fun Phy2018Obj(
    ...
    val physicsVM: Physics2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.PHYSICS2018
    val questionRoute = PhysicsObjYear.Obj2018.route
    ...
    val physicsQuestion by physicsVM.getPhysics2018.observeAsState(listOf<Physics>())
    val physicsQuestionR = physicsVM.getPhysics2018.value
