...
import com.pktech.presentation.screens.subjects.govt.year.govt2012.Government2012VM
...
import com.pktech.utill.SaveQuestionConstants.LITERATURE2012
...
fun Lit2012Obj(
    ...
    val literatureVM: Literature2012VM = hiltViewModel()
    ...
    val questionTitle = LITERATURE2012
    val questionRoute = LiteratureObjYear.Obj2012.route
    ...
    val literatureQuestion by literatureVM.getLiterature2012.observeAsState(listOf<Literature>())
    val literatureQuestionR = literatureVM.getLiterature2012.value
