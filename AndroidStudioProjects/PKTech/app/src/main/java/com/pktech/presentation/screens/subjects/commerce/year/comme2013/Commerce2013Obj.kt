...
fun Commerce2013Obj(
    ...
    val commerceVM: Commerce2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2013
    val questionRoute = CommerceObjYear.Obj2013.route
    ...
    val commerceQuestion by commerceVM.getCommerce2013.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2013.value
