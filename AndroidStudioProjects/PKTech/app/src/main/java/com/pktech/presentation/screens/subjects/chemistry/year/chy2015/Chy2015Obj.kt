package com.pktech.presentation.screens.subjects.chemistry.year.chy2015
...
fun Chy2015Obj(
    ...
    val chemistryVM: Chemistry2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2015
    val questionRoute = ChemistryObjYear.Obj2015.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2015.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2015.value
