...
fun Agric2013Obj(
    ...
    val agricultureVM: Agric2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2013
    val questionRoute = AgricultureObjYear.Obj2013.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2013.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2013.value
