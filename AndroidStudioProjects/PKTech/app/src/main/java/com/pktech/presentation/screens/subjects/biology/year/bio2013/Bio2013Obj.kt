...
fun Bio2013Obj(
    ...
    val biologyVM: Biology2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2013
    val questionRoute = BiologyObjYear.Obj2013.route
    ...
    val biologyQuestion by biologyVM.getBiology2013.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2013.value
