...
fun Account2020Obj(
    ...
    val account2020VM: Account2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ACCOUNTING2020
    val questionRoute = AccountObjYear.Obj2020.route
    ...
    val account2020 by account2020VM.getAccount2020.observeAsState(listOf<Account>())
    val account2020R = account2020VM.getAccount2020.value
    account2020::class.java
    ...
    val questionSize = account2020R?.account?.size
    ...
    val questionIndex = account2020R?.account?.get(currentIndex)?.objective?.id
    val currentQuestion = account2020R?.account?.get(currentIndex)?.objective?.question
    val mainOptionA = account2020R?.account?.get(currentIndex)?.objective?.optionA
    val mainOptionB = account2020R?.account?.get(currentIndex)?.objective?.optionB
    val mainOptionC = account2020R?.account?.get(currentIndex)?.objective?.optionC
    val mainOptionD = account2020R?.account?.get(currentIndex)?.objective?.optionD
    val answer = account2020R?.account?.get(currentIndex)?.objective?.explanation
    val currentInstructions = account2020R?.account?.get(currentIndex)?.objective?.instructions
    val correctOption = account2020R?.account?.get(currentIndex)?.objective?.correctOption
    val underline = account2020R?.account?.get(currentIndex)?.objective?.questionUnderline
    val endQuestion = account2020R?.account?.get(currentIndex)?.objective?.questionEnd
