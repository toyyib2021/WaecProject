...
fun Commerce2018Obj(
    ...
    val commerceVM: Commerce2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.COMMERCE2018
    val questionRoute = CommerceObjYear.Obj2018.route
    ...
    val commerceQuestion by commerceVM.getCommerce2018.observeAsState(listOf<Commerce>())
    val commerceQuestionR = commerceVM.getCommerce2018.value
