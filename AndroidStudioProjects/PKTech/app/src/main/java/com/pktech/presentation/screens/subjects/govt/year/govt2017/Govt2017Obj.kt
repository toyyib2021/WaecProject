...
fun Govt2017Obj(
    ...
    val governmentVM: Government2017VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2017
    val questionRoute = GovernmentObjYear.Obj2017.route
    ...
    val governmentQuestion by governmentVM.getGovernment2017.observeAsState(listOf<Government>())
    val governmentQuestionR = governmentVM.getGovernment2017.value
