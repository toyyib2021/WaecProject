...
fun Govt2013Obj(
    ...
    val governmentVM: Government2013VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.GOVERNMENT2013
    val questionRoute = GovernmentObjYear.Obj2013.route
    ...
    val governmentQuestion by governmentVM.getGovernment2013.observeAsState(listOf<Economics>())
    val governmentQuestionR = governmentVM.getGovernment2013.value
