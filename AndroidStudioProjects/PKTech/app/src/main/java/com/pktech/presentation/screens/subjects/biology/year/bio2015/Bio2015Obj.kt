...
fun Bio2015Obj(
    ...
    val biologyVM: Biology2015VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.BIOLOGY2015
    val questionRoute = BiologyObjYear.Obj2015.route
    ...
    val biologyQuestion by biologyVM.getBiology2015.observeAsState(listOf<Agriculture>())
    val biologyQuestionR = biologyVM.getBiology2015.value
