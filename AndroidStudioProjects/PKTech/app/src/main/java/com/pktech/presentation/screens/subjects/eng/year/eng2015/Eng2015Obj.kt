...
fun Eng2015Obj(
    ...
    val mainOptionA = english2015R?.english?.get(currentIndex)?.objective?.optionA
    val mainOptionB = english2015R?.english?.get(currentIndex)?.objective?.optionB
    val mainOptionC = english2015R?.english?.get(currentIndex)?.objective?.optionC
    val mainOptionD = english2015R?.english?.get(currentIndex)?.objective?.optionD
    val answer = english2015R?.english?.get(currentIndex)?.objective?.explanation
    val currentInstructions = english2015R?.english?.get(currentIndex)?.objective?.instructions
    val correctOption = english2015R?.english?.get(currentIndex)?.objective?.correctOption
