...
fun Chy2020Obj(
    ...
    val chemistryVM: Chemistry2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.CHEMISTRY2020
    val questionRoute = ChemistryObjYear.Obj2020.route
    ...
    val chemistryQuestion by chemistryVM.getChemistry2020.observeAsState(listOf<Agriculture>())
    val chemistryQuestionR = chemistryVM.getChemistry2020.value
