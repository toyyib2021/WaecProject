package com.pktech.presentation.screens.subjects.agriculture.year.agric2018
...
fun Agric2018Obj(
    ...
    val agricultureVM: Agric2018VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2018
    val questionRoute = AgricultureObjYear.Obj2018.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2018.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2018.value
