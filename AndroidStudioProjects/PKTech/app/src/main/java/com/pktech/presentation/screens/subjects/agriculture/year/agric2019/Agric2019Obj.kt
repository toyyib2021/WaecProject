package com.pktech.presentation.screens.subjects.agriculture.year.agric2019
...
fun Agric2019Obj(
    ...
    val agricultureVM: Agric2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2019
    val questionRoute = AgricultureObjYear.Obj2019.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2019.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2019.value
