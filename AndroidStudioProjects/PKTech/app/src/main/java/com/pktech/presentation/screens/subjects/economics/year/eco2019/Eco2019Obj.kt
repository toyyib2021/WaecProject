...
fun Eco2019Obj(
    ...
    val economicsVM: Economics2019VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2019
    val questionRoute = EconomicsObjYear.Obj2019.route
    ...
    val economicsQuestion by economicsVM.getEconomics2019.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2019.value
