...
fun Phy2012Obj(
    ...
    val physics2012VM: Physics2012VM = hiltViewModel()
    ...
    val physics2012 by physics2012VM.getPhysics2012.observeAsState(listOf<Physics>())
    val physics2012R = physics2012VM.getPhysics2012.value
    physics2012::class.java

    var currentIndex by remember { mutableStateOf(0) }

    val questionIndex = physics2012R?.physics?.get(currentIndex)?.objective?.id
    val currentQuestion = physics2012R?.physics?.get(currentIndex)?.objective?.question
    val mainOptionA = physics2012R?.physics?.get(currentIndex)?.objective?.optionA
    val mainOptionB = physics2012R?.physics?.get(currentIndex)?.objective?.optionB
    val mainOptionC = physics2012R?.physics?.get(currentIndex)?.objective?.optionC
    val mainOptionD = physics2012R?.physics?.get(currentIndex)?.objective?.optionD
    val answer = physics2012R?.physics?.get(currentIndex)?.objective?.explanation
    val essay = physics2012R?.physics?.get(currentIndex)?.objective?.essay
    val currentInstructions = physics2012R?.physics?.get(currentIndex)?.objective?.instructions
    val correctOption = physics2012R?.physics?.get(currentIndex)?.objective?.correctOption
        ...
        Scaffold(
            ...
            if (currentInstructions != null && questionIndex != null) {
                ...
                StudyObjUIItems(
                    ...
                    questionSize = physics2012R.physics.size.toString(),
                    studyOrTestState = studyOrTestKeyValue.value,
                    onSaveIconClick = {
