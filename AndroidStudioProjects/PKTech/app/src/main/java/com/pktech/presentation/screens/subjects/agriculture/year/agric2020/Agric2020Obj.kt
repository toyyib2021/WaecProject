...
fun Agric2020Obj(
    ...
    val agricultureVM: Agric2020VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.AGRICULTURE2020
    val questionRoute = AgricultureObjYear.Obj2020.route
    ...
    val agricultureQuestion by agricultureVM.getAgric2020.observeAsState(listOf<Agriculture>())
    val agricultureQuestionR = agricultureVM.getAgric2020.value
