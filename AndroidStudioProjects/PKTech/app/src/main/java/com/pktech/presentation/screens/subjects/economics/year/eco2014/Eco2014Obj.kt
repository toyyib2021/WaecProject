package com.pktech.presentation.screens.subjects.economics.year.eco2014
...
fun Eco2014Obj(
    ...
    val economicsVM: Economics2014VM = hiltViewModel()
    ...
    val questionTitle = SaveQuestionConstants.ECONOMICS2014
    val questionRoute = EconomicsObjYear.Obj2014.route
    ...
    val economicsQuestion by economicsVM.getEconomics2014.observeAsState(listOf<Economics>())
    val economicsQuestionR = economicsVM.getEconomics2014.value
